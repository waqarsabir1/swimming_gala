...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <link href="https://fonts.googleapis.com/css2?family=Nunito:wght@400;600;700&display=swap" rel="stylesheet">
          ...
          <!-- summernote -->
          <link rel="stylesheet" href="{{ URL::asset('dist/plugins/summernote/summernote-bs4.min.css') }}">
    </head>
...
<link rel="stylesheet" href="{{ URL::asset('dist/js/adminlte.js') }}"> 
<link rel="stylesheet" href="{{ URL::asset('dist/js/demo.js') }}"> 
<!-- AdminLTE dashboard demo (This is only for demo purposes) -->
<link rel="stylesheet" href="{{ URL::asset('dist/js/pages/dashboard.js') }}"> 
